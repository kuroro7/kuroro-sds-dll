...
namespace abase
{
	...
	public:
		vector_ptr(int n = 10) :__ivector(n) { assert("vector_ptr1" && (T)0 == (void*)0); }
		vector_ptr(int n, const T& val) :__ivector(n, val) { assert("vector_ptr2" && (T)0 == (void*)0); }
		vector_ptr(const vector_ptr<T>& rhs) :__ivector(rhs.__ivector) { assert("vector_ptr3" && (T)0 == (void*)0); }
